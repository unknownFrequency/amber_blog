...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Test web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 0WZJuaMQoGR-xsDdNk77q7HmuSN9XJDnB_kGI94zNHU
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("test.log", "w"))
  #
  #
end
